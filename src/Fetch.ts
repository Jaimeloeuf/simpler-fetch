...
export class Fetch {
  ...
  /**
   * ### About
   * This private method wraps the raw `#run` method to parse the response, validate the response if
   * a validator is provided, before formatting the return value to satisfy `ApiResponse<T>`.
   *
